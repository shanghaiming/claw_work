"""
Trend_Sensitive_MACD - 自适应设计模式指标

自适应设计模式指标 #5: Trend_Sensitive_MACD
...
class TV_Trend_Sensitive_MACD:
    """Trend_Sensitive_MACD - 自适应设计模式指标"""
    
    def __init__(self, base_period=14, sensitivity=2.0):
        """初始化自适应指标"""
        self.name = "Trend_Sensitive_MACD"
        self.description = "自适应设计模式指标 #5: Trend_Sensitive_MACD"
...
def trend_sensitive_macd(high, low, close, volume=None):
    """
    简化的函数接口
    ...
    返回:
        ...
        condition_info: 市场条件信息
    """
    indicator = TV_Trend_Sensitive_MACD()
...
if __name__ == "__main__":
    ...
    # 创建指标实例
    indicator = TV_Trend_Sensitive_MACD(base_period=14, sensitivity=2.0)
