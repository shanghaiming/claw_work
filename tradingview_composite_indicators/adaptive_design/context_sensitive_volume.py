"""
Context_Sensitive_Volume - 自适应设计模式指标

自适应设计模式指标 #18: Context_Sensitive_Volume
...
class TV_Context_Sensitive_Volume:
    """Context_Sensitive_Volume - 自适应设计模式指标"""
    
    def __init__(self, base_period=14, sensitivity=2.0):
        """初始化自适应指标"""
        self.name = "Context_Sensitive_Volume"
        self.description = "自适应设计模式指标 #18: Context_Sensitive_Volume"
...
def context_sensitive_volume(high, low, close, volume=None):
    """
    简化的函数接口
    ...
    返回:
        ...
        condition_info: 市场条件信息
    """
    indicator = TV_Context_Sensitive_Volume()
...
if __name__ == "__main__":
    ...
    # 创建指标实例
    indicator = TV_Context_Sensitive_Volume(base_period=14, sensitivity=2.0)
