"""
Market_Phase_Detector - 自适应设计模式指标

自适应设计模式指标 #14: Market_Phase_Detector
...
class TV_Market_Phase_Detector:
    """Market_Phase_Detector - 自适应设计模式指标"""
    
    def __init__(self, base_period=14, sensitivity=2.0):
        """初始化自适应指标"""
        self.name = "Market_Phase_Detector"
        self.description = "自适应设计模式指标 #14: Market_Phase_Detector"
...
def market_phase_detector(high, low, close, volume=None):
    """
    简化的函数接口
    ...
    返回:
        ...
        condition_info: 市场条件信息
    """
    indicator = TV_Market_Phase_Detector()
...
if __name__ == "__main__":
    ...
    # 创建指标实例
    indicator = TV_Market_Phase_Detector(base_period=14, sensitivity=2.0)
