"""
Market_Regime_Detector - 复合系统模式指标

复合系统模式指标 #20: Market_Regime_Detector
基于TradingView复合系统设计思想：
1. 整合多个基础指标 (RSI, SMA, DX, PPO)
2. 使用科学组合方法（加权、投票、分层）
3. 提供综合市场视角
4. 提高信号可靠性和稳定性
...
class TV_Market_Regime_Detector:
    """Market_Regime_Detector - 复合系统模式指标"""
    
    def __init__(self):
        """初始化复合系统指标"""
        self.name = "Market_Regime_Detector"
        self.description = "复合系统模式指标 #20: Market_Regime_Detector"
        self.author = "OpenClaw量化系统"
        self.version = "1.0.0"
        self.base_indicators = ['RSI', 'SMA', 'DX', 'PPO']
    ...
    def plot_style(self):
        ...
        return {
            ...
            "components": ['RSI', 'SMA', 'DX', 'PPO'],
            "weights": self.weights
        }

def market_regime_detector(high, low, close, volume=None):
    """
    简化的函数接口
    ...
    返回:
        ...
        system_health: 系统健康度指标
    """
    indicator = TV_Market_Regime_Detector()
