"""
Technical_Sentiment_Index - 复合系统模式指标

复合系统模式指标 #4: Technical_Sentiment_Index
基于TradingView复合系统设计思想：
1. 整合多个基础指标 (TRIX, ATR, EMA, CCI)
2. 使用科学组合方法（加权、投票、分层）
3. 提供综合市场视角
4. 提高信号可靠性和稳定性
...
class TV_Technical_Sentiment_Index:
    """Technical_Sentiment_Index - 复合系统模式指标"""
    
    def __init__(self):
        """初始化复合系统指标"""
        self.name = "Technical_Sentiment_Index"
        self.description = "复合系统模式指标 #4: Technical_Sentiment_Index"
        self.author = "OpenClaw量化系统"
        self.version = "1.0.0"
        self.base_indicators = ['TRIX', 'ATR', 'EMA', 'CCI']
    ...
    def plot_style(self):
        ...
        return {
            ...
            "components": ['TRIX', 'ATR', 'EMA', 'CCI'],
            "weights": self.weights
        }

def technical_sentiment_index(high, low, close, volume=None):
    """
    简化的函数接口
    ...
    返回:
        ...
        system_health: 系统健康度指标
    """
    indicator = TV_Technical_Sentiment_Index()
