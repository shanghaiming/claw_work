"""
Conditional_Momentum - 自适应设计模式指标

自适应设计模式指标 #8: Conditional_Momentum
...
class TV_Conditional_Momentum:
    """Conditional_Momentum - 自适应设计模式指标"""
    
    def __init__(self, base_period=14, sensitivity=2.0):
        """初始化自适应指标"""
        self.name = "Conditional_Momentum"
        self.description = "自适应设计模式指标 #8: Conditional_Momentum"
...
def conditional_momentum(high, low, close, volume=None):
    """
    简化的函数接口
    ...
    返回:
        ...
        condition_info: 市场条件信息
    """
    indicator = TV_Conditional_Momentum()
...
if __name__ == "__main__":
    ...
    # 创建指标实例
    indicator = TV_Conditional_Momentum(base_period=14, sensitivity=2.0)
