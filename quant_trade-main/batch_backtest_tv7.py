...
from strategies.custom_4ma_deviation_strategy import Custom4MaDeviationStrategy
from strategies.sequential_reversal_strategy import SequentialReversalStrategy
from strategies.pocket_pivot_strategy import PocketPivotStrategy
# Retest SuperTrendTP with fixed version
...
STRATEGIES = {
    'Custom4MaDev': (Custom4MaDeviationStrategy, {}),
    'SequentialRev': (SequentialReversalStrategy, {}),
    'PocketPivot': (PocketPivotStrategy, {}),
    'SuperTrendTP_fixed': (SuperTrendTPStrategy, {}),
}
