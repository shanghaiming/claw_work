...
from strategies.trendline_breakout_strategy import TrendlineBreakoutStrategy
from strategies.adaptive_regime_momentum_strategy import AdaptiveRegimeMomentumStrategy
from strategies.structural_momentum_strategy import StructuralMomentumStrategy
...
from strategies.institutional_bias_strategy import InstitutionalBiasStrategy
from strategies.breakout_pullback_strategy import BreakoutPullbackStrategy
from strategies.volatility_squeeze_strategy import VolatilitySqueezeStrategy
...
STRATEGIES = {
    'TrendlineBreakout': (TrendlineBreakoutStrategy, {}),
    'AdaptiveRegimeMom': (AdaptiveRegimeMomentumStrategy, {}),
    'StructuralMom': (StructuralMomentumStrategy, {}),
    'LiquiditySweep': (LiquiditySweepStrategy, {}),
    'FairValueGap': (FairValueGapStrategy, {}),
    'InstitutionalBias': (InstitutionalBiasStrategy, {}),
    'BreakoutPullback': (BreakoutPullbackStrategy, {}),
    'VolSqueeze': (VolatilitySqueezeStrategy, {}),
}
...
def run_batch():
    ...
    print(f"\n{'='*80}")
    print("SUMMARY - Batch 5 (8 strategies x 27 stocks)")
    print(f"{'='*80}")
