"""
批量回测TradingView策略 - 第二批
测试3个额外策略: MeanReversionCorridors, LinRegScaleIn, VolumeWeightedRSI
"""
import sys
import os
...
from strategies.mean_reversion_corridors_strategy import MeanReversionCorridorsStrategy
from strategies.linreg_scalein_strategy import LinRegScaleInStrategy
from strategies.volume_weighted_rsi_strategy import VolumeWeightedRSIStrategy
...
STRATEGIES = {
    'MeanReversion': (MeanReversionCorridorsStrategy, {}),
    'LinRegScaleIn': (LinRegScaleInStrategy, {}),
    'VolumeWeightedRSI': (VolumeWeightedRSIStrategy, {}),
}
