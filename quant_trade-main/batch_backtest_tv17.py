"""Batch 17: Tier 2 remaining - VolStrengthShift + QuadBB + CCIRSI"""
import sys, os, io, contextlib
sys.path.insert(0, os.path.dirname(__file__))
from core.data_loader import load_stock_data
from core.backtest_engine import BacktestEngine
from strategies.volume_strength_shift_strategy import VolumeStrengthShiftStrategy
from strategies.quad_bb_fusion_strategy import QuadBBFusionStrategy
from strategies.ccirsi_fusion_strategy import CCIRSIFusionStrategy
...
STRATS = {
    'VolStrengthShift': (VolumeStrengthShiftStrategy, {}),
    'QuadBBFusion': (QuadBBFusionStrategy, {}),
    'CCIRSIFusion': (CCIRSIFusionStrategy, {}),
}

for sn, (sc, sp) in STRATS.items():
    print(f"\n策略: {sn}", flush=True)
    t=0; c=0; p=0
