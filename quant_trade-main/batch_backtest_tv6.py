...
from strategies.minervini_sepa_strategy import MinerviniSepaStrategy
from strategies.structural_tension_strategy import StructuralTensionStrategy
from strategies.ema_super_cloud_strategy import EmaSuperCloudStrategy
from strategies.delta_pressure_strategy import DeltaPressureStrategy
...
from strategies.convergence_protocol_strategy import ConvergenceProtocolStrategy
...
STRATEGIES = {
    'MinerviniSEPA': (MinerviniSepaStrategy, {}),
    'StructTension': (StructuralTensionStrategy, {}),
    'EmaSuperCloud': (EmaSuperCloudStrategy, {}),
    'DeltaPressure': (DeltaPressureStrategy, {}),
    'AegisHMA': (AegisHmaSentinelStrategy, {}),
    'WyckoffAccum': (WyckoffAccumulationStrategy, {}),
    'ConvergenceProto': (ConvergenceProtocolStrategy, {}),
}
...
def run_batch():
    ...
    print(f"\n{'='*80}")
    print("SUMMARY - Batch 6 (7 strategies x 27 stocks)")
    print(f"{'='*80}")
