"""Batch 12: Proportional Volume Split + Volatility Terrain Engine"""
import sys, os, io, contextlib
sys.path.insert(0, os.path.dirname(__file__))
from core.data_loader import load_stock_data
from core.backtest_engine import BacktestEngine
from strategies.proportional_volume_split_strategy import ProportionalVolumeSplitStrategy
from strategies.volatility_terrain_strategy import VolatilityTerrainStrategy
...
STRATS = {
    'PropVolSplit': (ProportionalVolumeSplitStrategy, {}),
    'VolTerrain': (VolatilityTerrainStrategy, {}),
}
