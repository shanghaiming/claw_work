...
def process_single_stock(ts_code: str = "000001.SZ") -> bool:
    ...
    """
    # 固定路径参数（直接修改函数体即可调整）
    data_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)),'week_data2')      # 数据目录
    output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)),'analysis_results_week')  # 输出目录
