...
# ============================================================================
# 策略改造: 添加SystemSummaryAndImprovementStrategy类
# 将系统总结与改进系统转换为交易策略
# ============================================================================

class SystemSummaryAndImprovementStrategy(BaseStrategy):
    """系统总结与改进策略"""
    ...
    def generate_signals(self):
        ...
        """
        # 获取学习总结
        learning_summary = self.summary_system.summarize_learning_achievements()
