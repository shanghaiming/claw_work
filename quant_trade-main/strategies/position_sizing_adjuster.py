...
# ============================================================================
# 策略改造: 添加PositionSizingAdjusterStrategy类
# 将仓位规模调整器转换为交易策略
# ============================================================================

class PositionSizingAdjusterStrategy(BaseStrategy):
    """仓位规模调整策略"""
