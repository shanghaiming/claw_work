"""Batch 11: Supply/Demand ATR Zones + Volume Delta Pressure"""
import sys, os, io, contextlib
sys.path.insert(0, os.path.dirname(__file__))
from core.data_loader import load_stock_data
from core.backtest_engine import BacktestEngine
from strategies.supply_demand_atr_zone_strategy import SupplyDemandATRZoneStrategy
from strategies.volume_delta_pressure_strategy import VolumeDeltaPressureStrategy
...
STRATS = {'SupplyDemandATR': (SupplyDemandATRZoneStrategy, {}), 'VolDeltaPressure': (VolumeDeltaPressureStrategy, {})}
...
for sn, (sc, sp) in STRATS.items():
    ...
    for sym, nm in STOCKS.items():
        try:
            ...
            print(f"  {nm}({sym}): ERROR - {str(e)[:60]}", flush=True)
