...
from strategies.fib_volatility_cloud_strategy import FibVolatilityCloudStrategy
from strategies.advanced_rsi_momentum_strategy import AdvancedRsiMomentumStrategy
from strategies.vwap_deviation_strategy import VwapDeviationStrategy
from strategies.adaptive_keltner_strategy import AdaptiveKeltnerStrategy
from strategies.cci_regime_strategy import CciRegimeStrategy
from strategies.wavetrend_strategy import WaveTrendStrategy
from strategies.ha_ema_cross_strategy import HaEmaCrossStrategy
...
STRATEGIES = {
    'FibVolCloud': (FibVolatilityCloudStrategy, {}),
    'AdvRsiMomentum': (AdvancedRsiMomentumStrategy, {}),
    'VwapDeviation': (VwapDeviationStrategy, {}),
    'AdaptiveKeltner': (AdaptiveKeltnerStrategy, {}),
    'CciRegime': (CciRegimeStrategy, {}),
    'WaveTrend': (WaveTrendStrategy, {}),
    'HaEmaCross': (HaEmaCrossStrategy, {}),
}
...
def run_batch():
    ...
    print(f"\n{'='*80}")
    print("SUMMARY - Batch 4 (7 strategies x 27 stocks)")
    print(f"{'='*80}")
