...
"""
未知策略详细适配器
基于 stock_filter_v2.ipynb 深度解析生成的策略适配器
...
class Stock_filter_v2Strategy:
    ...
    "exit_rules": [],
    "signal_frequency": 0.1471264367816092
}
        """
        signals = []
            ...
            for i in range(1, len(data)):
                ...
                if prev_short <= prev_long and curr_short > curr_long:
                    signals.append({
                        ...
                        'confidence': 0.6,
                        'source_strategy': 'stock_filter_v2'
                    })
                # 死叉卖出
...
def test_strategy():
    ...
    if os.path.exists(test_file):
        ...
        # 创建策略
        strategy = Stock_filter_v2Strategy()
