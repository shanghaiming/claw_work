...
"""
涨停板策略详细适配器
基于 limit_up_board.ipynb 深度解析生成的策略适配器
...
class Limit_up_boardStrategy:
    ...
    "entry_rules": [],
    "exit_rules": [],
    "signal_frequency": 0.06097560975609756
}
        """
        signals = []
            ...
            for i in range(1, len(data)):
                ...
                if prev_short <= prev_long and curr_short > curr_long:
                    signals.append({
                        ...
                        'confidence': 0.6,
                        'source_strategy': 'limit_up_board'
                    })
                # 死叉卖出
...
def test_strategy():
    ...
    if os.path.exists(test_file):
        ...
        # 创建策略
        strategy = Limit_up_boardStrategy()
