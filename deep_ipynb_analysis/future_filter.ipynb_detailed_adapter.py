...
"""
期货策略详细适配器
基于 future_filter.ipynb 深度解析生成的策略适配器
...
class Future_filterStrategy:
    ...
    "entry_rules": [],
    "exit_rules": [],
    "signal_frequency": 0.08793103448275862
}
        """
        signals = []
...
def test_strategy():
    ...
    if os.path.exists(test_file):
        ...
        # 创建策略
        strategy = Future_filterStrategy()
