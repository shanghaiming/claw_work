"""
CDL3BLACKCROWS - 蜡烛图形态识别指标

基于TA-Lib的CDL3BLACKCROWS函数实现
...
class TV_CDL3BLACKCROWS:
    """TradingView风格的CDL3BLACKCROWS蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDL3BLACKCROWS"
        self.description = "蜡烛图形态识别: CDL3BLACKCROWS"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDL3BLACKCROWS(open, high, low, close)
            return result
