"""
CDLBELTHOLD - 蜡烛图形态识别指标

基于TA-Lib的CDLBELTHOLD函数实现
...
class TV_CDLBELTHOLD:
    """TradingView风格的CDLBELTHOLD蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLBELTHOLD"
        self.description = "蜡烛图形态识别: CDLBELTHOLD"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLBELTHOLD(open, high, low, close)
            return result
