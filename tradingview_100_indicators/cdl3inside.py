"""
CDL3INSIDE - 蜡烛图形态识别指标

基于TA-Lib的CDL3INSIDE函数实现
...
class TV_CDL3INSIDE:
    """TradingView风格的CDL3INSIDE蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDL3INSIDE"
        self.description = "蜡烛图形态识别: CDL3INSIDE"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDL3INSIDE(open, high, low, close)
            return result
