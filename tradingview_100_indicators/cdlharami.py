...
class TV_CDLHARAMI:
    """TradingView风格的CDLHARAMI蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLHARAMI"
        self.description = "蜡烛图形态识别: CDLHARAMI"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLHARAMI(open, high, low, close)
            return result
