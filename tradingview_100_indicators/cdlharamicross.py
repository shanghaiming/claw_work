"""
CDLHARAMICROSS - 蜡烛图形态识别指标

基于TA-Lib的CDLHARAMICROSS函数实现
...
class TV_CDLHARAMICROSS:
    """TradingView风格的CDLHARAMICROSS蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLHARAMICROSS"
        self.description = "蜡烛图形态识别: CDLHARAMICROSS"
