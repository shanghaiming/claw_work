"""
CDLKICKING - 蜡烛图形态识别指标

基于TA-Lib的CDLKICKING函数实现
...
class TV_CDLKICKING:
    """TradingView风格的CDLKICKING蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLKICKING"
        self.description = "蜡烛图形态识别: CDLKICKING"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLKICKING(open, high, low, close)
            return result
