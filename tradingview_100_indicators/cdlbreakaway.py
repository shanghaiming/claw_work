"""
CDLBREAKAWAY - 蜡烛图形态识别指标

基于TA-Lib的CDLBREAKAWAY函数实现
...
class TV_CDLBREAKAWAY:
    """TradingView风格的CDLBREAKAWAY蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLBREAKAWAY"
        self.description = "蜡烛图形态识别: CDLBREAKAWAY"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLBREAKAWAY(open, high, low, close)
            return result
