"""
CDLENGULFING - 蜡烛图形态识别指标

基于TA-Lib的CDLENGULFING函数实现
...
class TV_CDLENGULFING:
    """TradingView风格的CDLENGULFING蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLENGULFING"
        self.description = "蜡烛图形态识别: CDLENGULFING"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLENGULFING(open, high, low, close)
            return result
