"""
CDLHIGHWAVE - 蜡烛图形态识别指标

基于TA-Lib的CDLHIGHWAVE函数实现
...
class TV_CDLHIGHWAVE:
    """TradingView风格的CDLHIGHWAVE蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLHIGHWAVE"
        self.description = "蜡烛图形态识别: CDLHIGHWAVE"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLHIGHWAVE(open, high, low, close)
            return result
