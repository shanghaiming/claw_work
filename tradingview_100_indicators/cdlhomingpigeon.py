"""
CDLHOMINGPIGEON - 蜡烛图形态识别指标

基于TA-Lib的CDLHOMINGPIGEON函数实现
...
class TV_CDLHOMINGPIGEON:
    """TradingView风格的CDLHOMINGPIGEON蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLHOMINGPIGEON"
        self.description = "蜡烛图形态识别: CDLHOMINGPIGEON"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLHOMINGPIGEON(open, high, low, close)
            return result
