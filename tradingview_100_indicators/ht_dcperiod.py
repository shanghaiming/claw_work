"""
TV_HT_DCPERIOD - TradingView风格的HT_DCPERIOD指标

基于TA-Lib的HT_DCPERIOD函数实现
...
class TV_HT_DCPERIOD:
    """TradingView风格的HT_DCPERIOD指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "HT_DCPERIOD"
        self.description = "基于TA-Lib HT_DCPERIOD函数的TradingView风格实现"
