"""
CDLDOJISTAR - 蜡烛图形态识别指标

基于TA-Lib的CDLDOJISTAR函数实现
...
class TV_CDLDOJISTAR:
    """TradingView风格的CDLDOJISTAR蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLDOJISTAR"
        self.description = "蜡烛图形态识别: CDLDOJISTAR"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLDOJISTAR(open, high, low, close)
            return result
