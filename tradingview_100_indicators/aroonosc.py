"""
TV_AROONOSC - TradingView风格的AROONOSC指标

基于TA-Lib的AROONOSC函数实现
...
class TV_AROONOSC:
    """TradingView风格的AROONOSC指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "AROONOSC"
        self.description = "基于TA-Lib AROONOSC函数的TradingView风格实现"
