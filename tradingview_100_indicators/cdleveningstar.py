"""
CDLEVENINGSTAR - 蜡烛图形态识别指标

基于TA-Lib的CDLEVENINGSTAR函数实现
...
class TV_CDLEVENINGSTAR:
    """TradingView风格的CDLEVENINGSTAR蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLEVENINGSTAR"
        self.description = "蜡烛图形态识别: CDLEVENINGSTAR"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLEVENINGSTAR(open, high, low, close)
            return result
