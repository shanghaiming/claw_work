...
class TV_CDLINNECK:
    """TradingView风格的CDLINNECK蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLINNECK"
        self.description = "蜡烛图形态识别: CDLINNECK"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLINNECK(open, high, low, close)
            return result
