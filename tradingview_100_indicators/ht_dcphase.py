"""
TV_HT_DCPHASE - TradingView风格的HT_DCPHASE指标

基于TA-Lib的HT_DCPHASE函数实现
...
class TV_HT_DCPHASE:
    """TradingView风格的HT_DCPHASE指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "HT_DCPHASE"
        self.description = "基于TA-Lib HT_DCPHASE函数的TradingView风格实现"
