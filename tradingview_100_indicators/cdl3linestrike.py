"""
CDL3LINESTRIKE - 蜡烛图形态识别指标

基于TA-Lib的CDL3LINESTRIKE函数实现
...
class TV_CDL3LINESTRIKE:
    """TradingView风格的CDL3LINESTRIKE蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDL3LINESTRIKE"
        self.description = "蜡烛图形态识别: CDL3LINESTRIKE"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDL3LINESTRIKE(open, high, low, close)
            return result
