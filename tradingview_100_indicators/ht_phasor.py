"""
TV_HT_PHASOR - TradingView风格的HT_PHASOR指标

基于TA-Lib的HT_PHASOR函数实现
...
class TV_HT_PHASOR:
    """TradingView风格的HT_PHASOR指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "HT_PHASOR"
        self.description = "基于TA-Lib HT_PHASOR函数的TradingView风格实现"
