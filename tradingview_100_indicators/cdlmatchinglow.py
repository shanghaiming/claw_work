"""
TV_CDLMATCHINGLOW - TradingView风格的CDLMATCHINGLOW指标

基于TA-Lib的CDLMATCHINGLOW函数实现
...
class TV_CDLMATCHINGLOW:
    """TradingView风格的CDLMATCHINGLOW指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDLMATCHINGLOW"
        self.description = "基于TA-Lib CDLMATCHINGLOW函数的TradingView风格实现"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDLMATCHINGLOW(open, high, low, close)
            return result
