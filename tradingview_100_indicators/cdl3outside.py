"""
CDL3OUTSIDE - 蜡烛图形态识别指标

基于TA-Lib的CDL3OUTSIDE函数实现
...
class TV_CDL3OUTSIDE:
    """TradingView风格的CDL3OUTSIDE蜡烛图形态指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "CDL3OUTSIDE"
        self.description = "蜡烛图形态识别: CDL3OUTSIDE"
    ...
    def calculate(self, open, high, low, close):
        ...
        """
        try:
            result = talib.CDL3OUTSIDE(open, high, low, close)
            return result
