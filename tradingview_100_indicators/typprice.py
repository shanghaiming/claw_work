"""
TV_TYPPRICE - TradingView风格的TYPPRICE指标

基于TA-Lib的TYPPRICE函数实现
...
class TV_TYPPRICE:
    """TradingView风格的TYPPRICE指标"""
    
    def __init__(self):
        """初始化指标"""
        self.name = "TYPPRICE"
        self.description = "基于TA-Lib TYPPRICE函数的TradingView风格实现"
